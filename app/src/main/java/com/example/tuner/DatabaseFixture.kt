...
//        Create data in BasicTuner table
        ...
        basicTuner = BasicTunerModel(1, "Drop D", 1, TuneEnum.D2, TuneEnum.A2,TuneEnum.D3,TuneEnum.G3,TuneEnum.B3,TuneEnum.E4, null, null, null, null);
        handler2.insertData(basicTuner)

        basicTuner = BasicTunerModel(1, "4-string standard", 2, TuneEnum.E1, TuneEnum.A1,TuneEnum.D1,TuneEnum.G2,null, null, null, null, null, null);
        handler2.insertData(basicTuner)

        basicTuner = BasicTunerModel(1, "Drop D 4-string", 2, TuneEnum.D1, TuneEnum.A1,TuneEnum.D1,TuneEnum.G2, null, null, null, null, null, null);
        handler2.insertData(basicTuner)
    }
}