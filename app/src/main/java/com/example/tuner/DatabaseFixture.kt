...
//        Create data in BasicTuner table
        ...
        basicTuner = BasicTunerModel(3, "4-string standard", 2, false, 8, TuneEnum.E1, TuneEnum.A1,TuneEnum.D2,TuneEnum.G2,null, null, null, null, null, null);
        handler2.insertData(basicTuner, true)

        basicTuner = BasicTunerModel(4, "Drop D 4-string", 2,  false,7, TuneEnum.D1, TuneEnum.A1,TuneEnum.D2,TuneEnum.G2, null, null, null, null, null, null);
        handler2.insertData(basicTuner, true)

        basicTuner = BasicTunerModel(5, "Drop A 5-string", 2,  false,6, TuneEnum.A1, TuneEnum.E1, TuneEnum.A1,TuneEnum.D2,TuneEnum.G2, null, null, null, null, null);
        handler2.insertData(basicTuner, true)
    }
}